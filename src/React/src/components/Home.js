    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        {loading? (
          ...
          <div>
            <LineCharts
              title={`Issues for all repos in last 2 year`}
              data={githubRepoData?.issues}
            />
            <StackedBarCharts
              title={`Stars for all repos in last 2 year`}
              data={githubRepoData?.stars}
            />
            <BarCharts
              title={`Forks for all repo in last 2 year`}
            ...
            <Typography variant="h5" component="div" gutterBottom>
              ...
              <img
                  src={
                    githubRepoData?.createdStatsIssuesUrls?.stat_forecast_fit_image_url
                  }
                  alt={"All Issues Data for Created Issues"}
                  loading={"lazy"}
                />
            ...
            <Typography variant="h5" component="div" gutterBottom>
              ...
              <img
                  src={
                    githubRepoData?.closedStateIssuesUrls?.stat_forecast_fit_image_url
                  }
                  alt={"All Issues Data for Closed Issues"}
                  loading={"lazy"}
                />
            ...
            <Typography variant="h5" component="div" gutterBottom>
              ...
              <img
                  src={
                    githubRepoData?.statsPullAtImagesUrls?.stat_forecast_fit_image_url
                  }
                  alt={"All Issues Data for Pulls"}
                  loading={"lazy"}
                />
            ...
            <Divider
              ...
              <div>
                ...
                {/* Render the all issues data image for closed issues*/}
                <img
                  src={githubRepoData?.commitsAtImageUrls?.all_issues_data_image}
            ...
            <Typography variant="h5" component="div" gutterBottom>
              ...
              <img
                  src={
                    githubRepoData?.statsCommitsATImagesUrls?.stat_forecast_fit_image_url
                  }
                  alt={"All Issues Data for Commits"}
                  loading={"lazy"}
                />
